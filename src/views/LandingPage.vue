...
<template>
        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">Masjid Al-Ikhlas</h5>
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Silahkan Login</a>
                        </li>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5 style="color: aliceblue;">Masjid Al-Ikhlas</h5>
                    <p style="color: aliceblue;">Jl. Menuju Kebaikan</p>
                    <a href="#table"><button type="button" class="btn btn-secondary">Selengkapnya</button></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="headerpapan">
            <h1>Papan Donasi <br /> Masjid Al-Ikhlas </h1>
        </div>
